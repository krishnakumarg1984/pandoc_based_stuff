...
\begin{document}
\begin{tikzpicture}[node distance=0mm and 0mm,every node/.style={draw,very thin, align=left,{font=\scriptsize},minimum height=10mm}]
    ...
    \node (forwardproblem) {Parameters\\Model Equations};
\end{tikzpicture}
\end{document}